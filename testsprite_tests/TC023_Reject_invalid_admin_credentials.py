...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Acceso Administrador' button to open the admin login page and observe the login form.
        ...
        # --> An error notification should be visible after submitting invalid credentials.
        await page.locator("xpath=/html/body/div[1]/section").nth(0).scroll_into_view_if_needed()
        # Assert-outcome: failed
        # Assert: Expected the notifications region to display an error notification.
        await expect(page.locator("xpath=/html/body/div[1]/section").nth(0)).to_be_visible(timeout=15000), "Expected the notifications region to display an error notification."
